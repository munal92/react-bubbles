...
tokens are using for secure the data 
- [ ] What steps can you take in your web apps to keep your data secure?
store encryrpted token in local storage or cookies and use protected routes
- [ ] Describe how web servers work.
web servers are  store, process and deliver web pages to clients. 
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
post, get, put, and delete correspond to create , read, update, and delete.
